...
module.exports = function (app, plugin) {
  return {
    group: 'course data',
    optionKey: 'nwp_BRG_mag',
    title: 'Next Waypoint Bearing Mangetic (based on nextWaypointBearingTrue and magneticVarition based on GTC)',
    derivedFrom: ['navigation.courseGreatCircle.nextPoint.bearingTrue', 'navigation.magneticVariation'],
    ...
    calculator: function (nextWaypointBrgTrue, magneticVariation) {
      ...
      return [{ path: 'navigation.courseGreatCircle.nextPoint.bearingMagnetic', value: nextWaypointBrgMag }]
    }
  }
}
